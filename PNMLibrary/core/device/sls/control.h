...
private:
  ...
  static constexpr std::array<std::string_view, cunit_info_length>
      cunit_info_paths{RANK_STATE_PATH,
                       RANK_ACQUISITION_COUNT_PATH,
                       RANK_FREE_SIZE_PATH,
                       RANK_REGION_BASE_SIZE_PATH,
                       RANK_REGION_BASE_OFFSET_PATH,
                       RANK_REGION_INST_SIZE_PATH,
                       RANK_REGION_INST_OFFSET_PATH,
                       RANK_REGION_CFGR_SIZE_PATH,
                       RANK_REGION_CFGR_OFFSET_PATH,
                       RANK_REGION_TAGS_SIZE_PATH,
                       RANK_REGION_TAGS_OFFSET_PATH,
                       RANK_REGION_PSUM_SIZE_PATH,
                       RANK_REGION_PSUM_OFFSET_PATH};
