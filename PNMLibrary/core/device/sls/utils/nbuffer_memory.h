// core/device/sls/utils/nbuffer_memory.h - sls n-buffered mem support *C++*//
...
public:
  ...
  InterleavedPointer get_buffer(uint8_t rank, Type type) const;
  InterleavedPointer get_buffer_by_index(uint8_t cunit, uint8_t index) const;
